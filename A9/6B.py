...
from A7 import inputs as inputs
from A7 import regression
...
def lin_regression(file_):
    regression.linear_regression(inputs.load_file_to_array(file_))
